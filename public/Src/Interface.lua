...
function NurseNancy_ConfigScreen_SetChannel(spell, value)
  ...
  if (spell == "singleRess") then
    ...
    _G[NurseNancy_ConfigScreen_SingleRess_Channel:GetName() .. "Text"]:SetText(
      NurseNancyVars.singleRess_text
    )
  end
  ...
  if (spell == "massRess") then
    ...
    _G[NurseNancy_ConfigScreen_MassRess_Channel:GetName() .. "Text"]:SetText(
      NurseNancyVars.massRess_text
    )
  end
  ...
  if (spell == "combatRess") then
    ...
    _G[NurseNancy_ConfigScreen_CombatRess_Channel:GetName() .. "Text"]:SetText(
      NurseNancyVars.combatRess_text
    )
  end
  ...
  if (spell == "selfRess") then
    ...
    _G[NurseNancy_ConfigScreen_SelfRess_Channel:GetName() .. "Text"]:SetText(
      NurseNancyVars.selfRess_text
    )
  end
end
