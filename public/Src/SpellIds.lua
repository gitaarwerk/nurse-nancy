...
function NurseNancy.SpellIds.isSingleRess(spellId)
  local spellIds = {
    ...
    20770,
    25435,
    48171, -- Priest's Resurrection ranks 2-7
    20609,
    20610,
    20776,
    20777,
    25590,
    49277, -- Shaman's Ancestral Spirit ranks 2-7
    10322,
    10324,
    20772,
    20773,
    48949,
    48950, -- Paladin's Redemption ranks 2-7
  }
...
function NurseNancy.SpellIds.isCombatRess(spellId)
  local spellIds = {
    ...
    20748,
    26994,
    48477, -- Druid's Rebirth ranks 2-7
    20762,
    20763,
    20764,
    20765,
    27239,
    47883, -- Warlock's Soulstone Resurrection ranks 2-7
  }
...
function NurseNancy.SpellIds.isSelfRess(spellId)
  local spellIds = { 20608, 21169, 3026, 23701 } -- Shaman's Reincarnation (passive) -- Reincarnation (the actual self-ress cast) -- Use Soulstone (Warlock soulstone self-ress) -- Darkmoon card: Twisting Nether
...
function NurseNancy.SpellIds.isMassRess(spellId)
  local spellIds = { 212048, 212036, 212056, 212051, 212040, 361178, 83968, 1229924 } -- Shaman's Ancestral Vision -- Priest's Mass Resurrection -- Paladin's Absolution -- Monk's Reawaken -- Druid's Revitalize -- Evoker's Mass Return -- Mass Resurrection (Cata/MoP guild perk, for classic flavors) -- M3DDY (Midnight engineering mass-ress robot, usable by anyone)
